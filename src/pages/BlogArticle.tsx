                  ...
                  {tableOfContents.map(({ id, label }) => (
                    <li key={id}>
                      <button
                        ...
                        className={`text-left w-full px-3 py-2 rounded-md text-sm transition-all ${
                          activeSection === id
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <section id="introduction" className="mb-12">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    <a href="https://www.jasper.ai" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Jasper AI</a>,{" "}
                    <a href="https://neilpatel.com/ubersuggest/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Ubersuggest</a>,{" "}
                    <a href="https://klingai.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Kling</a>,{" "}
                    <a href="https://lovable.dev" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Lovable</a> et{" "}
                    <a href="https://nanobanana.app" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Nano Banana</a>.
                  </p>
                </section>

                {/* 1. Jasper AI */}
                <section id="jasper-ai" className="mb-12 scroll-mt-24">
                  ...
                  <div className="bg-destructive/5 border border-destructive/20 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-foreground mb-3">Inconvénients</h3>
                    <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
                ...
                {/* 2. Ubersuggest */}
                <section id="ubersuggest" className="mb-12 scroll-mt-24">
                  <h2 className="text-2xl font-bold text-foreground mb-4">
                ...
                {/* 3. Kling */}
                <section id="kling" className="mb-12 scroll-mt-24">
                  <h2 className="text-2xl font-bold text-foreground mb-4">
                ...
                {/* 4. Lovable */}
                <section id="lovable" className="mb-12 scroll-mt-24">
                  <h2 className="text-2xl font-bold text-foreground mb-4">
                ...
                {/* 5. Nano Banana */}
                <section id="nano-banana" className="mb-12 scroll-mt-24">
                  <h2 className="text-2xl font-bold text-foreground mb-4">
                ...
                <section id="conclusion" className="scroll-mt-24">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Pour rester compétitif en 2026, il est essentiel d'expérimenter, d'adapter et d'intégrer progressivement ces technologies au cœur des stratégies marketing. Tester un outil ou s'inscrire à une newsletter spécialisée peut constituer un premier pas concret vers cette transformation.
                  </p>
                </section>
              </div>
            </article>
